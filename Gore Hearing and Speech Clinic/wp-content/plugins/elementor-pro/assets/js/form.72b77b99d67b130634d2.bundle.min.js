            ...
            var s = elementorModules.frontend.handlers.Base.extend({
                ...
                validateFileSize(e) {
                    ...
                    Array.prototype.slice.call(s).forEach((e => {
                        r < e.size && (t.parent().addClass("elementor-error").append('<span class="elementor-message elementor-message-danger elementor-help-inline elementor-form-help-inline" role="alert">' + i + "</span>").find(":input").attr("aria-invalid", "true"), this.elements.$form.trigger("error"))
                    }))
                },
                beforeSend() {
            ...
            class FormSteps extends elementorModules.frontend.handlers.Base {
                ...
                buildSteps() {
                    this.elements.$stepWrapper.each(((e, t) => {
                        ...
                        i.addClass(r.step).removeClass(r.fieldGroup, r.column), e && i.addClass(r.hidden), this.setStepData(i.children(s.stepField)), i.append(i.nextUntil(this.elements.$stepWrapper).not(this.elements.$submitWrapper))
                    }))
                }
                setStepData(e) {
                    const t = {};
                ...
                createStepsIndicators() {
                    ...
                    if ("none" !== e.step_type) {
                        const {
                            selectors: s,
                            classes: r
                        } = this.getSettings(), i = r.indicators + "--type-" + e.step_type, n = [r.indicators, i];
                ...
                getStepIndicatorElement(e, t) {
                    const {
                        classes: s
                    } = this.getSettings(), r = this.getElementSettings(), i = this.getIndicatorStateClass(t), n = [s.indicator, i], a = jQuery("<div>", {
                        class: n.join(" ")
                    });
                    return r.step_type.includes("icon") && a.append(this.getStepIconElement(e)), r.step_type.includes("number") && a.append(this.getStepNumberElement(t)), r.step_type.includes("text") && a.append(this.getStepLabelElement(e.label)), a
                }
                ...
                getStepIconElement(e) {
                    const {
                        classes: t
                    } = this.getSettings(), s = [t.indicatorIcon, this.getIndicatorShapeClass()], r = jQuery("<div>", {
                        class: s.join(" ")
                    });
                    if (e.icon) r.html(e.icon);
                        ...
                        })), this.data.indicatorsWithObjectTags.push(t)), r.append(t)
                    }
                    return r
                }
                ...
                injectButtonsToSteps() {
                    ...
                    this.elements.$stepWrapper.each(((t, s) => {
                        ...
                        let n;
                        t ? (i.append(this.getStepButton("previous", t)), n = t === e - 1 ? this.getSubmitButton() : this.getStepButton("next", t)) : n = this.getStepButton("next", t), i.append(n), r.append(i)
                    }))
                }
                getButtonsContainer() {
                    const {
                ...
                getStepButton(e, t) {
                    const {
                        classes: s
                    } = this.getSettings(), r = this.getButton(e, t).on("click", (() => this.applyStep(e))), i = [s.fieldGroup, s.buttonWrapper, "elementor-field-type-" + e];
                    return jQuery("<div>", {
                        class: i.join(" ")
                    }).append(r)
                }
                ...
                getButton(e, t) {
                    const {
                        classes: s
                    } = this.getSettings(), r = this.elements.$submitButton.attr("class").match(/elementor-size-([^\W\d]+)/g), i = [s.elementorButton, r, s.button, s.button + "-" + e];
                ...
                updateStepsShape() {
                    ...
                    let a = "";
                    e.step_type.includes("icon") ? a = "icon" : e.step_type.includes("number") && (a = "number"), this.elements.$indicators.children(t.indicator + "__" + a).removeClass(i).addClass(n), this.state.stepsShape = e.step_icon_shape
                }
        ...
        2108: (e, t) => {
            ...
            class Recaptcha extends elementorModules.frontend.handlers.Base {
                ...
                addRecaptcha() {
                    ...
                    })), t ? this.elements.$recaptcha.data("widgetId", r) : (s.push(r), this.elements.$submit.on("click", (e => this.onV3FormSubmit(e, r))))
                }
                onV3FormSubmit(e, t) {
