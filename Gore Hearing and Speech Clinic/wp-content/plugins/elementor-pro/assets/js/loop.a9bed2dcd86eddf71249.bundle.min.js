    ...
    [149], {
        5030: (e, t, n) => {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                } = e, d = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : r, m = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null, c = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null;
                if (r === d) {
                ...
                const u = function createHandleElement(e, t) {
                    ...
                    const d = ["header", "footer"].includes(a ? .dataset.elementorType) ? "%s" : o("Edit %s", "elementor-pro"),
                        m = createElement({
                            ...
                            children: [createElement({
                                ...
                                tag: "div",
                                classNames: [`${r===t?i:l}__title`],
                                children: [document.createTextNode(r === t ? d.replace("%s", n) : o("Save %s", "elementor-pro").replace("%s", n))]
                            })]
                        }),
                        c = [i];
                    r !== t && c.push(l);
                    ...
                    return u.addEventListener("click", s), u
                }({
                    title: a,
                ...
                t.prepend(u), r === d && (t.dataset.editableElementorDocument = n)
            };
            const i = "elementor-document-handle",
                s = "elementor-edit-mode",
                r = "edit";
            t.EDIT_CONTEXT = r;
            const l = "elementor-document-save-back-handle",
                a = "save";
            ...
            function createElement(e) {
                ...
                return i.classList.add(...n), o.forEach((e => i.appendChild(e))), i
            }
            t.SAVE_CONTEXT = a
        },
        6685: (e, t, n) => {
            ...
            class Loop extends s.default {
                ...
                attachEditDocumentHandle() {
                    ...
                    const t = this.getElementSettings(),
                        ...
                        s = this.$element.find(i).first()[0];
                    s && (this.isFirstEdit() ? this.$element.find(".elementor-swiper-button").remove() : (0, r.default)({
                        element: s,
                ...
                onDestroy() {
                    elementorCommon.config.experimentalFeatures["taxonomy-filter"] && elementorProFrontend.modules.taxonomyFilter.removeWidgetFromLoopWidgetsStore(this.getID()), super.onDestroy()
                }
            }
            t.default = Loop
        },
